                    ...
                    <div class="row ">
                        <div class="col-md-5 card shade mw-center mh-center">
                            ...
                            @elseif(Request::is('employer/*'))
                                <form method="POST" action="{{ route('employer.login') }}"class="p-5">
                                    @csrf
                                    <div class="form-group m-0 bmd-form-group">
                                        <label for="exampleInputEmail1" class="bmd-label-static">Email address</label>
                                        <input type="email" name="email" class="form-control" id="exampleInputEmail1"
                                    ...
                                    <div class=" justify-content-center pt-3 pb-3 text-center">
                                        <a href="{{ route('employer.showRegister') }}"
                                            class="btn shade f-primary btn-block text-center">
                                            register
                                        </a>
                                    </div>
                                </form>
